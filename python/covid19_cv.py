...
if __name__ == '__main__':
    df_spain_cases = load_csv(spain_c19_casos_url, download=FORCE_DOWNLOAD)
    df_spain_deceased = load_csv(spain_c19_muertes_url, download=FORCE_DOWNLOAD)
    ...
    df_cv.to_csv(os.path.join(data_path, 'cv_covid19.csv'), index=False)

...
# Individual contact models (ICMs) are intended to be the stochastic microsimulation analogs to 
# deterministic compartmental models (DCMs). ICMs simulate disease spread on individual agents in 
# discrete time as a function of processes with stochastic variation.
...
simulate <- function(
  ...
  # data structure for the set of control parameters of the ICM model
  # see file "_icm.control.seiqhrf.R"
  ...
  # data structure for the initial values for each compartment
  # is part of the EpiModel package
  ...
  # data structure for the rates and probabilities paramterers
  # is part of the EpiModel package
  ...
  # simulates the SEIQHRF model. See "_icm.icm.seiqhrf.R"
  sim <- icm.seiqhrf(param, init, control)
  
  # stores the simulation results as a data-frame

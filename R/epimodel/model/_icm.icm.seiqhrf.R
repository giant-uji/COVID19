...
icm.seiqhrf <- function(param, init, control) {
  ...
  if (ncores == 1) {
      ...
      for (s in 1:control$nsims) {
        ...
        # runs function "initialize.icm" from script "_icm.mod.init.seiqhrf.R"
  ...
  # simulation process with parallelization
  if (ncores > 1) {  

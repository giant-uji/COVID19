...
source("file://C:/Users/nuria/OneDrive/myProjects/COVID-19/BEARmod-master/BEARmod-master/preprocess_small.R")
#Initial parameters
...
onerun <- data.frame(results[10])

#plot 
#infected 
plot(seq(50), onerun$X3)


save(results,file="file://C:/Users/nuria/OneDrive/myProjects/COVID-19/BEARmod-master/BEARmod-master/results.RData")
# 
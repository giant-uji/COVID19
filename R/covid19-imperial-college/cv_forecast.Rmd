...
```{r, out.width="0.75\\linewidth", include=TRUE, fig.align="center", fig.cap=c("CV Deaths forecast"), echo=FALSE}
...
```{r, out.width="0.75\\linewidth", include=TRUE, fig.align="center", fig.cap=c("Spain deaths forecast"), echo=FALSE}
